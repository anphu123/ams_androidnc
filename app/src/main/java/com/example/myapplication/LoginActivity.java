        ...
        btnDangNhap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dbHelper.checkLogin(sv)) {
                    Toast.makeText(LoginActivity.this, R.string.success_message, Toast.LENGTH_SHORT).show();
...
//                    Toasty.error(LoginActivity.this, R.string.error_message, Toasty.LENGTH_SHORT, true).show();
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                Toast.makeText(LoginActivity.this, R.string.success_message, Toast.LENGTH_SHORT).show();
//                Toast.success(LoginActivity.this, R.string.success_message, Toasty.LENGTH_SHORT, true).show();
                Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                startActivity(intent);
            }
